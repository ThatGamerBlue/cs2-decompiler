...
interface Command {
    ...
    enum class Basic(
        ...
        _103(listOf(ENTITYOVERLAY, IFTYPE, COMSUBID), listOf()),
        _104(listOf(ENTITYOVERLAY), listOf()),
        CC_FIND(listOf(COMPONENT, COMSUBID), listOf(BOOL), true),
        IF_FIND(listOf(COMPONENT), listOf(BOOLEAN), true),
        _202(listOf(ENTITYOVERLAY), listOf(BOOL)),
        _203(listOf(ENTITYOVERLAY, COMSUBID), listOf(BOOL)),
        ...
        _3130(listOf(GRAPHIC, INT), listOf()),
        ...
        _7033(listOf(STRING, INT), listOf(BOOLEAN)),
        ...
        _7202(listOf(INT, INT, INT, INT, INT), listOf(ENTITYOVERLAY)),
        _7203(listOf(INT, INT, INT, INT, INT), listOf(ENTITYOVERLAY)),
        _7204(listOf(_COORD, INT, INT, INT, INT, INT), listOf(ENTITYOVERLAY)),
        _7205(listOf(), listOf(INT)),
        _7206(listOf(INT), listOf(ENTITYOVERLAY)),
        _7207(listOf(), listOf(INT)),
        _7208(listOf(), listOf(INT)),
        _7209(listOf(_COORD, INT), listOf(ENTITYOVERLAY)),
