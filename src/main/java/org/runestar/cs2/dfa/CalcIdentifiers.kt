...
class CalcIdentifiers(private val fs: FunctionSet) {
    ...
    companion object : Phase {
        ...
        private val STRONG = setOf(MESUID, CHATFILTER, RANK, WORLD, /*KEY,*/ IFTYPE, SETSIZE, SETPOSH, SETPOSV, SETTEXTALIGNH, SETTEXTALIGNV, CHATTYPE, WINDOWMODE, CLIENTTYPE, PLATFORMTYPE, SETTING)
    }
